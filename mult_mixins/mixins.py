...
class StaffMixin(UserPassesTestMixin):
    ...
    permission_denied_message = _("You are not a staff user. You do not have the right to view this page.")            # from AccessMixin
...
class SuperuserMixin(UserPassesTestMixin):
    ...
    raise_exception = True
    permission_denied_message = _("You are not a superuser user. You do not have the right to view this page.")            # from AccessMixin
...
class OwnerMixin(UserPassesTestMixin):
    ...
    permission_denied_message = _("You are not the owner of the page. You cannot view it.")            # from AccessMixin
    raise_exception = True
    owner_kwargs = None
...
class OwnerOrStaffMixin(UserPassesTestMixin):
    ...
    permission_denied_message = _("You are not the owner of the page nor a staff user. You cannot view it.")            # from AccessMixin
    raise_exception = True
    owner_kwargs = None
